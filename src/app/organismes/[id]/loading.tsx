...
export default function OrganDetailLoading() {
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="animate-pulse mb-4 h-4 w-40 rounded bg-gray-200" />
      ...
      <div className="mb-8 flex flex-wrap items-center gap-2">
        <div className="animate-pulse h-5 w-40 rounded bg-gray-100" />
